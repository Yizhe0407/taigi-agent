  ...
  <div class="flex flex-col gap-2 overflow-y-auto flex-1 min-h-0">
    ...
    >
      ...
      <div class="col-start-3 row-start-1 justify-self-center flex flex-row items-center gap-2 max-[1180px]:col-start-2 max-[1180px]:row-start-2 max-[1180px]:justify-self-start max-[1180px]:self-start max-[340px]:col-start-1 max-[340px]:col-span-2 max-[340px]:justify-self-center">
        <div
          class="inline-flex min-w-[7.5rem] max-w-full items-center justify-center gap-2 whitespace-nowrap py-2 px-3.5 rounded-full text-base font-bold max-[1180px]:min-w-0 max-[420px]:py-1.5 max-[420px]:px-2.5 max-[420px]:text-sm"
        ...
        <span v-if="route.carId" class="text-sm font-mono font-bold text-kiosk-ink border-2 border-kiosk-line bg-white rounded-lg px-2.5 py-0.5 tracking-widest shrink-0">{{ route.carId }}</span>
      </div>
